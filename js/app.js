(() => {
    ...
    function initSliders() {
        let pageSlider = new core(".slider", {
        ...
        let pageBgSlder = new core(".background", {
            modules: [ Controller, EffectFade ],
            speed: 500
        });
        let pageTextSlder = new core(".text", {
            modules: [ Controller, EffectFade ],
            speed: 500,
            effect: "fade",
            fadeEffect: {
        ...
        pageSlider.controller.control = pageBgSlder;
        pageBgSlder.controller.control = pageTextSlder;
    }
    ...
    function getIndex(el) {
        return Arrow.from(el.parentNode.children).indexOf(el);
    }
